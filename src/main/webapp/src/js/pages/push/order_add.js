/**
 * Created by yangzb01 on 2017-11-22.
 */
    ...
    * */
    ...
    getDetail:function () {
        $(document).api({
            on:'now',
            method:'post',
            action:'get loan order add info',
            data:{
            ...
            onSuccess:function(data){
                ...
                DATA.basicInfoAmount = data.baseInfo.amount;
                DATA.itemType = data.baseInfo.itemType;
                ...
                if(data.baseInfo.itemType!='BILL' && data.baseInfo.itemType !='BANK_BILL')
                    $('input[name="amount"]').attr('placeholder','推单金额小于'+data.baseInfo.amount);
            ...
            $('.ui.form').form(init.validate).api({
                ...
                onSuccess:function(data){
                    ...
                    $.uiAlert({
                        ...
                        time: 1,
                        onClosed: function () {
                            window.location.href = '/loan_push_order/index?loanPushId='+utils.getUrlParam('loanPushId');
                        }
                    })
                },
                onFailure:function(data){
