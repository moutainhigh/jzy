/**
 * Created by zhangyy04 on 2017/6/16.
 */
    ...
    common_options: {
        ...
        init: {
            ...
            UploadProgress: function(up, file) {
                $("#"+up.settings.file_box).prev('.percent').html(file.percent+'%');
            ...
            FileUploaded: function(up, file, info) {
                ...
                //添加文件显示
                $("#"+up.settings.file_box).prev('.percent').html('');
                $("#"+up.settings.file_box).append('<div class="fbox"><a target="_blank" href="'+url+'">'+fileTempName+'</a>&nbsp;<i class="ui red button mini clearFile" onclick="clearFile(this)">删除</i></div>')
