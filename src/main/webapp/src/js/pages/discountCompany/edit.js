...
$(document).api({
    ...
    onSuccess:function (data) {
            ...
            if(filesArr_a){
                ...
                if(filesLen_a>0){
                    for(var i=0;i<filesLen_a;i++){
                        $("#fileBox0").append('<div class="fbox"><a target="_blank" href="'+filesArr_a[i].dataValue+'">'+filesArr_a[i].keyName+'</a>&nbsp;<i class="ui red button mini clearFile" onclick="clearFile(this)">删除</i></div>')
                    }
                }else{
                    $("#fileBox0").append('')
                }
            ...
            if(filesArr_b){
                ...
                if(filesLen_b>0){
                    for(var i=0;i<filesLen_b;i++){
                        $("#fileBox1").append('<div class="fbox"><a target="_blank" href="'+filesArr_b[i].dataValue+'">'+filesArr_b[i].keyName+'</a>&nbsp;<i class="ui red button mini clearFile" onclick="clearFile(this)">删除</i></div>')
                    }
                }else{
                    $("#fileBox1").append('')
                }
        ...
        $("#form-borrower input,#form-borrower select").each(function(n,ele){
